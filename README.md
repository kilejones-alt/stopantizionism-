# STOPAZ Full Site — Iteration 10 Final
...
4. After deployment, open the published site and confirm that `index.html`, the primary navigation, The Exhibition, and the Antizionism room load from the final Pages URL.
